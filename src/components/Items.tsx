...
const ItemsUI = ({ menuItems, session }: Props) => {
   ...
   return (
      <nav>
                  ...
                  <div className="items-center gap-10 md:flex">
                     ...
                     <div>
                        {!session?.user ? (
                           ...
                           <span className="group flex cursor-pointer items-center justify-center gap-3.5 rounded-md p-2 text-sm font-medium">
                              <div>
                                 <svg
                                    xmlns="http://www.w3.org/2000/svg"
                                    width="20"
         ...
         {/* mobile navigation */}
         <div
            className={`fixed z-40 flex w-full origin-top flex-col gap-12 overflow-hidden bg-gray-100 duration-700 dark:bg-gray-900 dark:text-slate-100 lg:hidden ${
               !open ? 'h-0' : 'h-full'
            }`}
         >
            <div className="p-5">
